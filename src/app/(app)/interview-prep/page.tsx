    ...
    <div className="mx-auto max-w-2xl">
      ...
      {question && (
        <Card className="mt-5 p-6">
          ...
          <p className="font-display text-lg font-semibold leading-snug text-ink">{question}</p>
          ...
          {!feedback ? (
            <>
              ...
              />
              <Button className="mt-3 w-full" disabled={evaluating || answer.trim().length < 10} onClick={evaluate}>
            ...
            <div className="mt-5 space-y-5">
              ...
              <Button variant="secondary" className="w-full" onClick={getQuestion}>
